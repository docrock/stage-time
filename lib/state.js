...
export function makeState(show = {}) {
  return {
    ...
    timer: {
      ...
      showUpNext: true,
      blackout: false,
      // Do public-facing outputs follow the internal projection, or hold the
      // published schedule until a human republishes? See lib/publish.js.
      publicFollowsLive: false,
    },
    message: null,
    // Producer edits that touch the live or next session wait here until the TD arms them.
    pending: null,
    // What the outside world was told. See lib/publish.js.
    published: { at: null, times: {} },
